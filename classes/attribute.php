...
class Attribute {
  ...
  public static function attributes() {
    if (static::$attributes === null) {
      ...
      static::$attributes[] = new Attribute('collectible', 'collectible', 'collectible', ['collectible', 'col'], Key::SPECIAL);
      ...
      static::$attributes[] = new Attribute('text', 'text', 'text', ['text', 'te'], Key::TEXT_ANY);
      static::$attributes[] = new Attribute('id', 'id', 'system_id', ['id'], Key::TEXT_BEGIN);
      static::$attributes[] = new Attribute('howToEarnGolden', 'howToEarnGolden', 'how_to_earn_golden', ['eg'], Key::TEXT_ANY);
